	...
	<div class="container">
		...
		<div class="pull-right">
			<div class="beta-breadcrumb font-large">
				<a href=".">Trang chủ</a> / <span>Product</span>
			</div>
		</div>
		<div class="clearfix"></div>
	</div>
			...
			<div class="col-md-4">
				...
				@endif
					<div class="single-item-header">
						<a href="chitiet/{{$sp->id}}.html"><img src="assets/dest/images/products/{{$sp->image}}" alt="" height="250px"></a>
					</div>
					...
					<div class="single-item-caption">
						<a class="add-to-cart pull-left" href="{{route('giohang.addToCart',['id'=>$sp->id])}}"><i class="fa fa-shopping-cart"></i></a>
